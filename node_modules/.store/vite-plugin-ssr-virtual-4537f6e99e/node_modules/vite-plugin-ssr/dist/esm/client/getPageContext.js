...
function assertPristineUrl() {
    ...
    assertUsage(urlPathnameOriginal === urlPathnameCurrent, `You changed the page's URL before the hydration finished (from \`${urlPathnameOriginal}\` to \`${urlPathnameCurrent}\`). Make sure that the hydration finished before changing the URL by using the \`onHydrationEnd()\` hook.`);
}
