...
exports.RenderErrorPage = exports._injectAssets = exports.pipeNodeStream = exports.pipeWebStream = exports.dangerouslySkipEscape = exports.escapeInject = exports.createPageRenderer = exports.renderPage = void 0;
var renderPage_1 = require("./renderPage");
Object.defineProperty(exports, "renderPage", { enumerable: true, get: function () { return renderPage_1.renderPage; } });
...
var RenderErrorPage_1 = require("./renderPage/RenderErrorPage");
Object.defineProperty(exports, "RenderErrorPage", { enumerable: true, get: function () { return RenderErrorPage_1.RenderErrorPage; } });
require("./page-files/setup");
require("../shared/assertSingleVersion");
const utils_1 = require("./utils");
(0, utils_1.assertUsage)(!(0, utils_1.isBrowser)(), 'The `vite-plugin-ssr` module cannot be imported in the browser.');
