...
const loadPageRoutes_1 = require("./route/loadPageRoutes");
...
async function route(pageContext) {
    ...
    const { pageRoutes, onBeforeRouteHook } = await (0, loadPageRoutes_1.loadPageRoutes)(pageContext);
    const pageContextAddendum = {};
    if (onBeforeRouteHook) {
        const hookResult = await (0, callOnBeforeRouteHook_1.callOnBeforeRouteHook)(onBeforeRouteHook, pageContext);
