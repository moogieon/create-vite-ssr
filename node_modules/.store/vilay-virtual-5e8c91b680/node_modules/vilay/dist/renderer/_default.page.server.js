import { dangerouslySkipEscape, escapeInject, pipeNodeStream, } from 'vite-plugin-ssr';
...
export async function render(pageContext) {
    const { initialCompletion, totalCompletion, pipe, getStoreSource } = renderReact(pageContext);
...
const renderReact = (pageContext) => {
    const { Page, exports: { initRelayEnvironment }, } = pageContext;
    ...
    const { pipe, abort: _abort } = renderToPipeableStream(React.createElement(PageShell, { pageContext: pageContext, relayEnvironment: relayEnvironment, routeManager: new RouteManager({
            initialPage: Page,
